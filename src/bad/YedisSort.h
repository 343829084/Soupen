...
INLINE void YedisSort<T, CompareOperator, threshold>::sort(T *data, int64_t size)
{
  CompareOperator co;
...
template<typename T, typename CompareOperator, int64_t threshold>
void YedisSort<T, CompareOperator, threshold>::sort_(T *data, int64_t left, int64_t right, const CompareOperator &co)
{
...
template<typename T, typename CompareOperator, int64_t threshold>
INLINE void YedisSort<T, CompareOperator, threshold>::insertion_sort(T *data, int64_t left, int64_t right, const CompareOperator &co)
{
...
template<typename T, typename CompareOperator, int64_t threshold>
INLINE const T& YedisSort<T, CompareOperator, threshold>::get_pivot(T *data, int64_t left, int64_t right, const CompareOperator &co)
{
